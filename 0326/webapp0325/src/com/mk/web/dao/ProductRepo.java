...
public class ProductRepo {
	...
	public ProductRepo() {
		...
		iphone.setDescription("6인치, 1334x750 Renina HD Display, "
			+ "8-megapixel Camera");
		...
		Product notebook = 
				new Product("P2111", "LG 그램2021", 2500000);		
		notebook.setDescription("15인치, 2800x1850 OLED HD Display, "
				+ "인텔i7 11세대, 메모리 DDR4");
		...
		Product tablet = 
				new Product("P3111", "삼성 갤럭시탭S7", 400000);		
		tablet.setDescription("10인치, 2000x1550 OLED HD Display, "
				+ "메모리 128G");
